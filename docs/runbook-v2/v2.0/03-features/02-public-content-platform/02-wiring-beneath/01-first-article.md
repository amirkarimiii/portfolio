...
Build the first complete article

```
step: Fill the article identity section
  Test the helper method for finding all the slugs
```
...
```
step: Fill the classification section
  Build the first series during classification
  Connect the tab of that built series with this article
```
...
```
step: Fill the body
  Here we have photo without caption in the body, photo with caption and reference to article and reference to series; all of it is tested
```

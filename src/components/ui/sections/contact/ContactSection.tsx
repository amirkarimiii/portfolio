    ...
    return (
        <section className="max-w-4xl mx-auto">
            <div className="py-2 px-5 mb-10">
                ...
                <div className="">
                    <Button asChild className="block w-full max-w-xl mx-auto text-center mt-2">
                        <Link href="https://calendar.app.google/7TVynmWgCn4J3JqK7">Book a call via Google Meet 👋</Link>
                    </Button>
                    <Button asChild variant="outline" className="block w-full max-w-xl mx-auto text-center mt-2">
            ...
            <p className="text-center text-xs mb-5">© all rights are reserved for me!</p>
        </section>
    );
}